          ...
          {selected.map((product, idx) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground">{product.starting_price != null && Number.isFinite(product.starting_price) ? `₹${product.starting_price.toLocaleString('en-IN')}` : '—'}</p>
              </div>
